...
[Instagram Graph API SDK](../README.md) / CreateCarouselContainerOptions

# Interface: CreateCarouselContainerOptions

Defined in: src/types/publishing.ts:73
...
Defined in: src/types/publishing.ts:75
